...
content = {
    ...
    "Я учитель": {
        ...
        'buttons': ['Я учитель Мат/Физ/Инф', 'Я учитель Ин. яза', "Я учитель Рус.яз/Лит-ра", "Я учитель Ист/общ"],
        'loose': False,
        'img': ''
    },
"Я учитель Ист/общ": {
        'text': """На какой день вам нужно расписание?""",
        'buttons': ["Понедельник(и)", "Вторник(и)", "Среда(и)", "Четверг(и)", "Пятница(и)"],
        'loose': False,
        'img': ''
   },
"Понедельник(и)": {
